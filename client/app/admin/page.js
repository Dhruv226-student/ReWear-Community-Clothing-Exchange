            ...
            {reportsLoading ? (
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <h3 className="font-semibold text-lg">{item.title}</h3>
                          <p className="text-sm text-muted-foreground">
                            Listed by {item.userName} • Reported by {item.reportedBy}
                          </p>
                        </div>
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-muted-foreground">{item.reportReason}</p>
                      </div>
                      <p className="text-sm mb-4">{item.description}</p>
                      <div className="flex gap-2">
                        <Button size="sm" onClick={() => handleResolveReport(item.id)}>
                          Resolve Report
                        </Button>
              ...
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground">No reported items to review at the moment.</p>
                </CardContent>
              </Card>
            )}
          </TabsContent>
